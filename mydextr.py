...
class MyDextr:
    ...
    def __init__(self, iface):
        ...
        self.dlg = MyDextrDialog()

        # Declare instance attributes
        self.actions = []
        self.menu = self.tr(u'&DEXTR-KerasTensorflow')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('MyDextr', message)
    ...
    def unload(self):
        ...
        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&DEXTR-KerasTensorflow'),
                action)
